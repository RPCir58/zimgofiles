...
export default function GamesPage() {
  ...
  const games = [
    ...
    {
      id: 2,
      title: "ScratchCraft Mobile",
      description: "Juega a Minecraft de Scratch desde ZIMGo. Compatible con modo táctil.",
      image: "/images/scratchcraft.png",
      link: "/zimgo-scratchcraft",
    },
    {
      id: 3,
