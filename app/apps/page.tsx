  ...
  const games = [
    {
      id: 1,
      title: "PixelCraft",
      description: "Editor de dibujos Pixel Art.",
      image: "/images/pixelcraft.png",
      link: "/apps/pixelcraft",
    },
    {
      id: 2,
      title: "Photoshop",
      description: "Versión de prueba de Photoshop desde ZIMGo.",
      image: "https://conciliafacil.es/wp-content/uploads/2024/05/photoshop.jpg",
      link: "/apps/photoshop",
    },
    {
      id: 3,
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="flex flex-col items-center justify-center text-center mb-12">
        ...
        <h1 className="text-4xl font-bold mb-6">Aplicaciones</h1>
        <p className="text-xl text-gray-600 max-w-2xl mb-8">Realiza diferentes tareas y usa herramientas desde ZIMGo.</p>
      </div>
